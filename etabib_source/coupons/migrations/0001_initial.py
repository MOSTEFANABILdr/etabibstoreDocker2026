    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('percentage', 'Percentage discount'), ('monetary', 'Money based coupon'), ('sponsorship', 'Sponsorship')], max_length=20, verbose_name='Type')),
                ('target', models.CharField(choices=[('1', 'abonnement'), ('2', 'econsultation')], default='1', max_length=2, verbose_name='Target')),
