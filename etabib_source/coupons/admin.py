...
class CouponAdmin(admin.ModelAdmin):
    change_list_template = "admin/change_coupon_list.html"
    list_display = [
        'created_at', 'code', 'type', 'get_value', 'user_count', 'user_limit', 'is_redeemed', 'valid_until', 'campaign'
    ]
    ...
    def get_value(self, inst):
        if inst.type == settings.COUPON_TYPES[2][0]:
            return OffrePrepaye.objects.get(id=inst.value)
        return inst.value
