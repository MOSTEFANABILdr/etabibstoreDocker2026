...
from stats.models import AtcdciStats


class Command(BaseCommand):
    help = 'migrate old atcdci statistics'
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            file_path = os.path.join(module_dir, 'atcstats.csv')
            ...
            with open(file_path) as csvfile:
                ...
                for row in readCSV:
                    ...
                    try:
                        ...
                        dci = DciAtc.objects.get(unique_id=unique_id)
